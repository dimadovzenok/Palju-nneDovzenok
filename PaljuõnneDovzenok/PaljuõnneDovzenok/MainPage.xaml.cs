...
namespace PaljuõnneDovzenok
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            opilane = new List<string>() { "Aleksandr Shevchenko", "Dima Dovzenok", "Jarik Panchenko" };
            number = new List<string>() { "56143908", "56189856", "5635841" };
        ...
        //рандомно отправляет поздравление 
